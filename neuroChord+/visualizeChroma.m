function out=visualizeChroma(f_chroma,parameter)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if isfield(parameter,'printPaperPosition')==0
    parameter.printPaperPosition = [1   10   50  15]; %[left, bottom, width, height]
end
...
if parameter.print == 1
    set(gca,'PaperPosition',parameter.printPaperPosition);
